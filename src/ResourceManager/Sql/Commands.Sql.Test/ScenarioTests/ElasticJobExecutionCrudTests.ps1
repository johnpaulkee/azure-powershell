...
#>
function Test-StartJobWithDefaultParam
{
...
#>
function Test-StopJobWithDefaultParam
{
	$a1 = Create-ElasticJobAgentTestEnvironment
	$jc1 = Create-JobCredentialForTest $a1
	$tg1 = Create-TargetGroupForTest $a1
...
#>
function Test-StopJobWithJobExecutionObject
{
	$a1 = Create-ElasticJobAgentTestEnvironment
	$jc1 = Create-JobCredentialForTest $a1
	$tg1 = Create-TargetGroupForTest $a1
...
#>
function Test-StopJobWithJobExecutionResourceId
{
	$a1 = Create-ElasticJobAgentTestEnvironment
	$jc1 = Create-JobCredentialForTest $a1
	$tg1 = Create-TargetGroupForTest $a1
...
<#
	...
	Tests creating a job with min parameters
#>
function Test-StopJobWithPiping
{
	$a1 = Create-ElasticJobAgentTestEnvironment
	$jc1 = Create-JobCredentialForTest $a1
	$tg1 = Create-TargetGroupForTest $a1
...
#>
function Test-GetJobStepExecutionWithDefaultParam
{
	$a1 = Create-ElasticJobAgentTestEnvironment
	$jc1 = Create-JobCredentialForTest $a1
	$tg1 = Create-TargetGroupForTest $a1
...
#>
function Test-GetJobStepExecutionWithJobExecutionObject
{
	$a1 = Create-ElasticJobAgentTestEnvironment
	$jc1 = Create-JobCredentialForTest $a1
	$tg1 = Create-TargetGroupForTest $a1
...
#>
function Test-GetJobStepExecutionWithJobExecutionResourceId
{
	$a1 = Create-ElasticJobAgentTestEnvironment
	$jc1 = Create-JobCredentialForTest $a1
	$tg1 = Create-TargetGroupForTest $a1
...
#>
function Test-GetJobStepExecutionWithPiping
{
	$a1 = Create-ElasticJobAgentTestEnvironment
	$jc1 = Create-JobCredentialForTest $a1
	$tg1 = Create-TargetGroupForTest $a1
...
<#
	...
	Tests get job step execution with default param
#>
function Test-GetJobTargetExecutionWithDefaultParam
{
	$a1 = Create-ElasticJobAgentTestEnvironment
	$jc1 = Create-JobCredentialForTest $a1
	$tg1 = Create-TargetGroupForTest $a1
...
<#
	...
	Tests get job step execution with job execution object
#>
function Test-GetJobTargetExecutionWithJobExecutionObject
{
	$a1 = Create-ElasticJobAgentTestEnvironment
	$jc1 = Create-JobCredentialForTest $a1
	$tg1 = Create-TargetGroupForTest $a1
...
<#
	...
	Tests get job step execution with job execution resource id
#>
function Test-GetJobTargetExecutionWithJobExecutionResourceId
{
	$a1 = Create-ElasticJobAgentTestEnvironment
	$jc1 = Create-JobCredentialForTest $a1
	$tg1 = Create-TargetGroupForTest $a1
...
<#
	...
	Tests get job step execution with piping
#>
function Test-GetJobTargetExecutionWithPiping
{
	$a1 = Create-ElasticJobAgentTestEnvironment
	$jc1 = Create-JobCredentialForTest $a1
	$tg1 = Create-TargetGroupForTest $a1
