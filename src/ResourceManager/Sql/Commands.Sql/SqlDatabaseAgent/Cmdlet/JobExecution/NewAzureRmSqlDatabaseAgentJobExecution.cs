...
{
    /// <summary>
    /// Defines the New-AzureRmSqlDatabaseAgentJobExecution Cmdlet
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AzureRmSqlDatabaseAgentJobExecution",
        SupportsShouldProcess = true,
        DefaultParameterSetName = DefaultParameterSet)]
    [OutputType(typeof(AzureSqlDatabaseAgentJobExecutionModel))]
    public class NewAzureSqlDatabaseAgentJobExecution : AzureSqlDatabaseAgentCmdletBase
    {
        /// <summary>
