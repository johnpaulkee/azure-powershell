...
namespace Microsoft.Azure.Commands.Sql.SqlDatabaseAgent.Model
{
    ...
    public class AzureSqlDatabaseAgentTargetModel
    {
        ...
        /// </summary>
        public string DatabaseTargetName { get; set; }

        /// <summary>
        /// Gets or sets the elastic pool name
        /// </summary>
        public string ElasticPoolTargetName { get; set; }

        /// <summary>
        /// Gets or sets the Shard Map Name
        /// </summary>
        public string ShardMapTargetName { get; set; }

        /// <summary>
        /// Gets or sets the Refresh Credential
        /// </summary>
