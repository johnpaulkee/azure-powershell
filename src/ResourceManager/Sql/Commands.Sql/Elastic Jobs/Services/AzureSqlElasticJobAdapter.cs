...
namespace Microsoft.Azure.Commands.Sql.ElasticJobs.Services
{
    ...
    public class AzureSqlElasticJobAdapter
    {
        ...
        public AzureSqlElasticJobAgentModel UpsertSqlDatabaseAgent(AzureSqlElasticJobAgentModel model)
        {
        ...
        public AzureSqlElasticJobAgentModel UpdateSqlDatabaseAgent(AzureSqlElasticJobAgentModel model)
        {
        ...
        public AzureSqlElasticJobAgentModel GetSqlDatabaseAgent(string resourceGroupName, string serverName, string agentName)
        {
        ...
        public JobTarget CreateTargetModel(AzureSqlElasticJobTargetModel target)
        {
        ...
        protected AzureSqlElasticJobTargetModel CreateAzureSqlDatabaseAgentTargetModel(
        ...
        /// <param name="resp">The management client server response to convert</param>
        /// <returns>The converted agent model</returns>
        private AzureSqlElasticJobTargetGroupModel CreateTargetGroupModelFromResponse(string resourceGroupName, string serverName, string agentName, Management.Sql.Models.JobTargetGroup resp)
        {
        ...
        private static AzureSqlElasticJobStepVersionModel CreateJobStepVersionModelFromResponse(
            ...
            JobStep resp)
        {
            AzureSqlElasticJobStepVersionModel jobStep = new AzureSqlElasticJobStepVersionModel
            {
                ResourceGroupName = resourceGroupName,
                ServerName = serverName,
                AgentName = agentName,
