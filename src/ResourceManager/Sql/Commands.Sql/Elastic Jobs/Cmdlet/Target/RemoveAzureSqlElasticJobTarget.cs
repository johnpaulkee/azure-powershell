...
namespace Microsoft.Azure.Commands.Sql.ElasticJobs.Cmdlet
{
    ...
    public class RemoveAzureSqlElasticJobTarget : AzureSqlElasticJobTargetCmdletBase<AzureSqlElasticJobTargetGroupModel>
    {
        ...
        {
            IEnumerable<AzureSqlElasticJobTargetModel> existingTargets = ModelAdapter.GetTargetGroup(this.ResourceGroupName, this.AgentServerName, this.AgentName, this.TargetGroupName).Targets.ToList();
